...
public class HourlyTipsExercise extends ExerciseBase {
	...
	public static void main(String[] args) throws Exception {
		...
		// the total tips collected by each driver
		DataStream<Tuple3<Long, Long, Float>> tipsPerHour = fares
		...
		// the highest tip total in each hour
		DataStream<Tuple3<Long, Long, Float>> hourlyMax = tipsPerHour
